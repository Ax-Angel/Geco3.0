...
def letter_change(language, busq):
    ...
    dicc = {'CHL': [('ty', "[T'|t']"), ('Ty', "[T'|t']"),('c', "[C|c|K|k|Q|q]"), ('C', "[C|c|K|k|Q|q]"), ('k', "[C|c|K|k|Q|q]"), 
                    ('K', "[C|c|K|k|Q|q]"), ('j', "[J|j|H|h|y|Y]"), ('J', "[J|j|H|h|y|Y]"), ('y', "[J|j|y|Y]"), ('Y', "[J|j|y|Y]"), 
                    ('a', "[A|a|Ʌ|ʌ]"), ('A', "[A|a|Ʌ|ʌ]"), ('ä', "[Ʌ|ʌ]"), ('Ä', "[Ʌ|ʌ]"), ('ö', "[Ʌ|ʌ]"), ('Ö', "[Ʌ|ʌ]"),
                    ('u', "[u|U|Ʌ|ʌ]"), ('U', "[u|U|Ʌ|ʌ]")],
               
            'MY': [],
            
            'MAZ': [('i', "[í|ì|ǐ|î|ī|i̠|į|i̜|i̹|í̠|į́|į̀|į̌|į̂|į̄|ï|ḯ|ï̀|ï̠|ɨ|ɨ́|ɨ̀|ɨ̌|ɨ̂|ɨ̄|ɨ̠|ɨ̜|ɨ̹|ɨ̠́]"),
                    ('I', "[í|ì|ǐ|î|ī|i̠|į|i̜|i̹|í̠|į́|į̀|į̌|į̂|į̄|ï|ḯ|ï̀|ï̠|ɨ|ɨ́|ɨ̀|ɨ̌|ɨ̂|ɨ̄|ɨ̠|ɨ̜|ɨ̹|ɨ̠́]"),
                    ('e', "[é|è|ě|ê|ē|e̠|ę|e̜|e̹|é̠|ę́|ę̀|ę̌|ę̂|ę̄|ë|ë́|ë̀|ë̌|ë̂|ë̠|ɛ|ɛ́|ɛ̀|ɛ̌|ɛ̂|ɛ̄|ɛ̠|ɛ̨|ξ|ɛ̠́|ɛ̨́|ɛ̜̌|ɛ̨̂|æ|ǽ|æ̀|æ̌|æ̂|ǣ|æ̠|æ̜|æ̹|ǽ̠|ǽ̜|æ̜̌|æ̜̂|ǣ̜]"),
                    ('E', "[é|è|ě|ê|ē|e̠|ę|e̜|e̹|é̠|ę́|ę̀|ę̌|ę̂|ę̄|ë|ë́|ë̀|ë̌|ë̂|ë̠|ɛ|ɛ́|ɛ̀|ɛ̌|ɛ̂|ɛ̄|ɛ̠|ɛ̨|ξ|ɛ̠́|ɛ̨́|ɛ̜̌|ɛ̨̂|æ|ǽ|æ̀|æ̌|æ̂|ǣ|æ̠|æ̜|æ̹|ǽ̠|ǽ̜|æ̜̌|æ̜̂|ǣ̜]"),
                    ('a', "[á|à|ǎ|â|ā|a̠|ą|a̜|a̹|á̠|ą́|ą̀|ą̌|ą̂|ą̄|ä|ä́|æ|ǽ|æ̀|æ̌|æ̂|ǣ|æ̠|æ̜|æ̹|ǽ̠|ǽ̜|æ̜̌|æ̜̂|ǣ̜]"),
                    ('A', "[á|à|ǎ|â|ā|a̠|ą|a̜|a̹|á̠|ą́|ą̀|ą̌|ą̂|ą̄|ä|ä́|æ|ǽ|æ̀|æ̌|æ̂|ǣ|æ̠|æ̜|æ̹|ǽ̠|ǽ̜|æ̜̌|æ̜̂|ǣ̜]"),
                    ('o', "[ó|ò|ǒ|ô|ō|o̠|ǫ|o̜|o̹|ó̠|ǫ́|ǫ̀|ǫ̌|ǫ̂|ǭ|ö|ö́|ö̀|ö̠]"), ('O', "[ó|ò|ǒ|ô|ō|o̠|ǫ|o̜|o̹|ó̠|ǫ́|ǫ̀|ǫ̌|ǫ̂|ǭ|ö|ö́|ö̀|ö̠]"),
                    ('u', "[ú|ù|ǔ|û|ū|u̠|ų|u̜|u̹|ú̠|ų́|ų̀|ų̌|ų̂|ų̄|ü|ǘ|ǜ|ü̠|ʉ|ʉ́|ʉ̀|ʉ̌|ʉ̂|ʉ̄|ʉ̠|ʉ̜|ʉ̹|ʉ̠́]"),
                    ('U', "[ú|ù|ǔ|û|ū|u̠|ų|u̜|u̹|ú̠|ų́|ų̀|ų̌|ų̂|ų̄|ü|ǘ|ǜ|ü̠|ʉ|ʉ́|ʉ̀|ʉ̌|ʉ̂|ʉ̄|ʉ̠|ʉ̜|ʉ̹|ʉ̠́]"),
                    ('ch', "[č|Č]"), ('Ch', "[č|Č]"), ('ts', "[¢]"), ('Ts', "[¢]"), ('sh', "[x|X]"), ('Sh', "[x|X]"),
                    ('b', "[b̜|b̠]"), ('B', "[b̜|b̠]"), ('ku', "[kw|Kw]"), ('Ku', "[kw|Kw]"), ('c', "[c|C|k|K]"), ('C', "[c|C|k|K]"),
                    ('k', "[k|K|c|C]"), ('K', "[k|K|c|C]"), ('n', "[n|N|ⁿ]"), ("'", "[ʔ|ˀ]"), ('h', "[j|J|h|H]"),
                    ('j', "[x|X|h|H]"), ('J', "[x|X|h|H]")],
            
            'MX': [('a', "[á|ā|a̠|à]"), ('A', "[á|ā|a̠|à]"), ('e', "[é|ē|e̠|è]"), ('E', "[é|ē|e̠|è]"), ('i', "[í|ī|i̠|ì|i|ɨ|ɨ̄|ɨ̠]"), 
                   ('I', "[í|ī|i̠|ì|i|ɨ|ɨ̄|ɨ̠]"), ('o', "[ó|ō|o̠|ò]"), ('O', "[ó|ō|o̠|ò]"), ('u', "[ú|ū|u̠|ù]"), ('U', "[ú|ū|u̠|ù]"),
                   ('ch', "[ty]"), ('ty', "[ch]"), ('k', "[c|q]"), ('c', "[k|q]"), ('q', "[c|k]"), ('h', "[']"), ("'", "[h]")],
            
            'NAH': [('a', "[Ā|ā|A̱|a̱]"), ('A', "[Ā|ā|A̱|a̱]"), ('e', "[Ē|ē|E̱|e̱|ɛ]"), ('E', "[Ē|ē|E̱|e̱|ɛ]"), ('i', "[Ī|ī|I̱|i̱]"), ('I', "[Ī|ī|I̱|i̱]"),
                    ('o', "[Ō|ō|Ö|ö|O̱|o̱]"), ('O', "[Ō|ō|Ö|ö|O̱|o̱]"), ('kw', "[ku|ku|Cu|cu]"), ('Kw', "[ku|ku|Cu|cu]"), ('k', "[C|c|Qu|qu]"),
                    ('K', "[C|c|Qu|qu]"), ('h', "[j|J]"), ('H', "[j|J]"), ('Ts', "[Tz]"), ('s', "[c|C|z|Z]"), ('S', "[c|C|z|Z]"),
                    ('w', "[Hu|hu|uh]"), ('W', "[Hu|hu|uh]")],
            
            'OT': [('a', "[a̱|á̠|à̠|ā|ą̌|ą̌|ą|ą́|ä̱|ą̀|á̧|à̜|a̜|a̹|à|ǎ|ă|ą̂|â|A̱|Ą́|Ą|Ă|A̜]"), ('A', "[a̱|á̠|à̠|ā|ą̌|ą̌|ą|ą́|ä̱|ą̀|á̧|à̜|a̜|a̹|à|ǎ|ă|ą̂|â|A̱|Ą́|Ą|Ă|A̜]"),
                   ('ä', "[ą|a̱]"), ('bb', "[b]"), ('b', "[b̠]"), ('cc', "[k]"), ('c', "[ɔ̀|ɔ|ɔ̌]"), ('dy', "[y|j]"), ('ö', "[ɔ|ɵ́|o̱|ø|Ø]"), ('Ö', "[ɔ|ɵ́|o̱|ø|Ø]"),
                   ('hu', "[w]"), ('h', "[j|w|J̌|ǰ|Ĵ|ĵ|ʰ]"), ('H', "[j|w|J̌|ǰ|Ĵ|ĵ|ʰ]"), ('e', "[E̱|e̱|é̱|è|ē|ę|ę́|ḝ|ę̌|ȩ|e̜|e̹|Ě|ě|ë̂|ë̌|ê|Ĕ|ĕ|è|ḝ|é̠|ɛ|ɛ̜|ɛ̠|Ɛ|Ɛ̌|ɛ̌|ɛ̂|ɛ́|ɛ̀|ɛ̜̌|ɛ̨̂|ɛ̜́|ξ|ξ́]"),
                   ('E', "[E̱|e̱|é̱|è|ē|ę|ę́|ḝ|ę̌|ȩ|e̜|e̹|Ě|ě|ë̂|ë̌|ê|Ĕ|ĕ|è|ḝ|é̠|ɛ|ɛ̜|ɛ̠|Ɛ|Ɛ̌|ɛ̌|ɛ̂|ɛ́|ɛ̀|ɛ̜̌|ɛ̨̂|ɛ̜́|ξ|ξ́]"), ('ë', "[ɛ|Ɛ]"), ('Ë', "[ɛ|Ɛ]"), ('gu', "[g|gu|w]"),
                   ('i', "[I̱|i̱|í̠|Į́|Į́|í̧|ī|Į|į|i̧|í̹|í̜|ǐ|į̌|Ĭ|ĭ|į́|į̀|ì|i̜|ï̀|ï̌|î|į̂]"), ('I', "[I̱|i̱|í̠|Į́|Į́|í̧|ī|Į|į|i̧|í̹|í̜|ǐ|į̌|Ĭ|ĭ|į́|į̀|ì|i̜|ï̀|ï̌|î|į̂]"),
                   ('k', "[c|qu|cc|qu]"), ('K', "[c|qu|cc|qu]"), ('m', "[m̠]"), ('o', "[O̱|o̱|ó̠|ó|ō|Ǒ|ǒ|Ŏ|ŏ|Ǫ|ǫ|o̧|ò|ɵ|ɵ̂|ɵ̌|ɵ́|ɵ̀|Ɵ̀|Ɵ|Ø|ø|Ǿ|ǿ|ö́]"),
                   ('O', "[O̱|o̱|ó̠|ó|ō|Ǒ|ǒ|Ŏ|ŏ|Ǫ|ǫ|o̧|ò|ɵ|ɵ̂|ɵ̌|ɵ́|ɵ̀|Ɵ̀|Ɵ|Ø|ø|Ǿ|ǿ|ö́]"), ('p', "[p̄]"), ('s', "[Ŝ|ŝ|z̄]"), ('S', "[Ŝ|ŝ|z̄]"), ('tz', "[s|z]"),
                   ('u', "[U̱|u̱|ú̱|ų̄|ú̧|ų̀|u̧|Ų|ų|ų́|u̜|u̹|ū|Ʉ|ʉ|Ʉ́|ʉ́|ʉ̜́|Ʉ̄|ʉ̠|ʉ̌|Ǔ|ǔ|ų̌|ų̂|ʉ̀]"), ('U', "[U̱|u̱|ú̱|ų̄|ú̧|ų̀|u̧|Ų|ų|ų́|u̜|u̹|ū|Ʉ|ʉ|Ʉ́|ʉ́|ʉ̜́|Ʉ̄|ʉ̠|ʉ̌|Ǔ|ǔ|ų̌|ų̂|ʉ̀]"),
                   ('w', "[hu|gu]"), ('W', "[hu|gu]"), ('x', "[Š|š|sho]"), ('X', "[Š|š|sho]"), ('y', "[dy]"), ('j', "[dy]"), ('z', "[s]")]
            }
